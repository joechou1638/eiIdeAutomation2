...
public class IdeTest extends TestBase {
  ...
  public void loginTest()  { 
	  ...
	  LOG.debug("DEBUG:  entering loginTest1()");	  
	  ...
	  LOG.debug("DEBUG: exiting loginTest1()");
  }
  ...
  public void searchTest() {
	  ...
	  LOG.debug("DEBUG: entering searchTest()");
	  ...
	  LOG.debug("DEBUG: exiting searchTest()");
  }
  ...
  public void sidebarTest() {
	  ...
	  LOG.debug("DEBUG: entering sidebarTest()");
	  TestUtil.mySleep(2000);
	  // Get list of models
	  ...
	  LOG.debug("DEBUG: exiting sidebarTest()");
  }
  ...
  public void agentServerTest() {
	  ...
	  LOG.debug("DEBUG: entering agentServerTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  ...
	  driver.findElement(By.xpath(getAddr("targetModAddr"))).click();
      TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: exiting agentServerTest()");
  }
  ...
  public void opsDeployTest() {
	  ...
	  LOG.debug("DEBUG: entering opsDeployTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  ...
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: exiting opsDeployTest()");  
  }
  ...
  public void changeFWTest() {
	  ...
	  LOG.debug("DEBUG: entering changeFWTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  //Click on target model to show device
	  ...
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: exiting changeFWTest()"); 
  }
  ...
  public void deleteDevTest() {
	  ...
	  LOG.debug("DEBUG: entering deleteDevTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  ...
	  if (!TestUtil.isModelActive(modName)) {
		  LOG.debug("DEBUG: no model of device to be deleted");
		  return;
	  }
	  ...
	  if (!TestUtil.isElementPresent(getAddr("delDevAddr"))) {
		  LOG.debug("DEBUG: no device to be deleted");
		  return;
	  }
	  ...
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: exiting deleteDevTest()");
  }
  ...
  public void deleteFImpTest() {
	  ...
	  LOG.debug("DEBUG: Entering deleteFIMpTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  ...
	  if (!TestUtil.isElementPresent(getAddr("delFImpButtonAddr"))) {
		  LOG.debug("DEBUG: no target factory imp to be deleted");
		  return;
	  }
	  ...
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: exiting deleteFIMpTest()");
  }
  ...
  public void addFImpTest() {
	  ...
	  LOG.debug("DEBUG: Entering addFIMpTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  // Go to Operations page
	  ...
	  if (TestUtil.isElementPresent(getAddr("delFImpButtonAddr"))) {
		  LOG.debug("DEBUG: target factory imp already added");
		  return;
	  }	 
	  ...
	  Assert.assertTrue(TestUtil.isElementPresent(getAddr("FImpMacListAddr")));
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: exiting addFIMpTest()");
  }
  
  @Test (dependsOnMethods = {"loginTest"})
  public void rmBondTest() {
      
	  LOG.debug("DEBUG: Entering rmBondTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName);
	  ...
	  Assert.assertTrue(!TestUtil.actionResultOK());	  
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: Exiting rmBondTest()");
  }
  ...
  public void addWebhookTest() {
	  ...
	  LOG.debug("DEBUG: Entering addWebhookTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName); 
	  // Go to Operations page
	  ...
	  if (TestUtil.getWebhook(whUrl) != null) {
		  //LOG.debug("DEBUG: webhook already existed, no adding.");
		  return;
	  }
	  ...
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: Exiting addWebhookTest()");
  }
  
  @Test (dependsOnMethods = {"loginTest"})
  public void rmWebhookTest() {	  
	  
	  LOG.debug("DEBUG: Entering rmWebhookTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName); 
	  // Go to Operations page
	  ...
	  if ( wh == null) {
		  LOG.debug("DEBUG: webhook not exist, no deleting.");
		  return;
	  }
	  ...
	  Assert.assertTrue((TestUtil.getWebhook(whUrl) == null));
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: Exiting rmWebhookTest()");
  }
  ...
  public void assignDevTest() {
	  ...
	  LOG.debug("DEBUG: Entering assignModelTest()");
	  TestUtil.mySleep(2000);
	  // Make sure on IDE page
	  TestUtil.beOnPage(idePageName); 
	  ...
	  TestUtil.mySleep(3000);
	  LOG.debug("DEBUG: Exiting assignModelTest()");
  }
  ...
  public void close() throws Exception {
	  ...
	  LOG.debug("DEBUG: Entering afterTest()");
	  TestUtil.mySleep(1000);
      // Logout 
      driver.navigate().refresh();
      TestUtil.mySleep(1000);
	  ...
	  LOG.debug("DEBUG: Exiting afterTest()");
  }
  
  @AfterTest
  public void quit() {
	  
	  LOG.debug("DEBUG: Entering quit()");
	  // Close all windows
	  driver.quit();
	  LOG.debug("DEBUG: Entering quit()");
  }
